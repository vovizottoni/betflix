...
@section('content-email')
    ...
    <div style="padding: 100px 0; text-align: center; color :#fff; margin: 0 auto; max-width: 100%; width: 600px">
        ...
        <p style="padding-top: 0px; font-size: 15px; font-weight: 100 !important; letter-spacing: 1px; line-height: 21px;">{{__('emails.you_made_withdrawal_request_in_approval')}}</p>
        <p style="padding-top: 0px; font-size: 15px; font-weight: 100 !important; letter-spacing: 1px; line-height: 21px;"><b>{{__('emails.transaction')}}</b> {{__('emails.withdrawal_via_pix')}}</p>
