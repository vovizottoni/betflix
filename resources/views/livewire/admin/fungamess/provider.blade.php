<div class="px-4 sm:px-6 lg:px-8 p-5">
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-base font-semibold leading-6 text-gray-900"> Provedores Fungamess Nux</h1>
      </div>
    </div>
          ...
          <table class="min-w-full divide-y divide-gray-300">
            <thead>
              <tr>
                ...
                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900"> Qtd. Jogos </th>
              </tr>
            </thead>
              ...
              <tr>
                ...
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-0">
                  <div class="flex items-center">
                    <div class="h-20 w-20 flex-shrink-0">
                      <a href="{{ route('admin.fungamess.game', $item->id) }}" class="link-provider" title="{{ $item->name }}"> 
                        <img class="h-20 w-20 rounded-full" src="{{$item->logo}}" alt="">
                      </a>
                    </div>
                  </div>
                </td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                    <div class="text-gray-900"> 
                      <a href="{{ route('admin.fungamess.game', $item->id) }}" class="link-provider" title="{{ $item->name }}"> {{ $item->name }} </a>
                     </div>
                </td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
