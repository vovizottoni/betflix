...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('group', function (Blueprint $table) {
            ...
            $table->enum('bonus2_two_levels', ['active', 'inactive'])->default('inactive');
            $table->bigInteger('bonus2_percentual_superior_integer')->nullable(); // 1, 2, 3 - 100, percentual representado como inteiro. Ex 20 => 20%
